# 🇪🇬 Awesome Egypt Tech Events

> A community-curated list of tech events, hackathons, student hiring events, bootcamps, and competitions across Egypt.
...
- [💼 Hiring & Career Events](#-hiring--career-events)
...
|-------|-----------|------|-------|-----------------|------|
| Egypt Hackathon | GDG Delta University | Feb–Mar (Annual) | Mansoura | ✅ | [gdg.community.dev](https://gdg.community.dev) |
| AISprint Hackathon | GDG on Campus – EUI | May (Annual) | Cairo | ✅ | [egyptinnovate.com](https://egyptinnovate.com) |
| Harvard HSIL Hackathon Hub | AUC | April (Annual) | Cairo (AUC) | ✅ | [aucegypt.edu](https://www.aucegypt.edu) |
| Hack the Future of Tourism | Capgemini Egypt | Feb (Annual) | Cairo | ✅ | [capgemini.com/eg-en](https://www.capgemini.com/eg-en) |
| New Valley Innovates | MCIT + New Valley Gov. | TBD | New Valley | ✅ | [egyptinnovate.com](https://egyptinnovate.com) |
...
## 💼 Hiring & Career Events

| Event | Organizer | When | Where | Link |
|-------|-----------|------|-------|------|
| Wuzzuf Career Fair | Wuzzuf | Multiple/Year | Cairo | [wuzzuf.net](https://wuzzuf.net) |
...
| Program | Organizer | When | Open To | Link |
|---------|-----------|------|---------|------|
| ICPC Egypt | ICPC + Egyptian Universities | Fall (Annual) | University Students | [icpc.global](https://icpc.global) |
| Google Solution Challenge | GDG on Campus Egypt | Jan–Apr (Annual) | University Students | [developers.google.com](https://developers.google.com/community/gdsc-solution-challenge) |
...
## 🛠️ Bootcamps & Training

| Program | Organizer | When | Topic | Link |
|---------|-----------|------|-------|------|
| Creativa AI Bootcamp | Creativa Hub (MCIT) | Multiple/Year | AI & Productivity | [creativa.gov.eg](https://creativa.gov.eg) |
| Hack Club STEM Annual Bootcamp | Hack Club STEM Egypt | Aug–Sep | Competitive Prog., Cybersec, App Dev | [stemeghackclub.org](https://stemeghackclub.org) |
| ITI Summer Training | ITI / MCIT | Summer | Various Tech Tracks | [iti.gov.eg](https://iti.gov.eg) |
| Digital Egypt Cubs | MCIT | TBD | Digital Literacy (Youth) | [mcit.gov.eg](https://mcit.gov.eg) |
